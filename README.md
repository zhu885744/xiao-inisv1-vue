...
xiao-inisv1-vue 是一款基于 Vue 3 + JavaScript + Vite 开发的现代化博客主题，专为个人博客和内容创作者设计。
...
xiao-inisv1-vue 主题不仅是一个博客模板，更是一个完整的内容管理解决方案，帮助你快速搭建专业的个人博客网站，专注于内容创作而不是技术实现。
...
将打包生成的 `dist` 目录内的所有文件上传到服务器主题目录即可。
